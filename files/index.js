...
const UUID = process.env.UUID || '23f54b95-f6e5-4b34-a14b-315908a0ec76'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chore22.bigtree66.netlib.re';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNDg2Mjk4Mzc5M2I2ZWU1MTAxNzE4NWNjNGNiOGFkMjkiLCJ0IjoiOTViYmU0MjItNWZmMy00ODM5LWFkNTktZjMwYmY0MGNmYzFmIiwicyI6Ik9HTTJZekZoT1RNdE5XRmxPUzAwWTJZNExXRXlOalV0WW1FMVpUazJNamsyWmpRMCJ9';
const CFIP = process.env.CFIP || 'rulet77bosnia.com';
const NAME = process.env.NAME || 'Choreo22';
